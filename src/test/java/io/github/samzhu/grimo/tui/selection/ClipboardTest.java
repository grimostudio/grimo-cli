...
class ClipboardTest {
    ...
    void osc52FormatUsesBase64AndBel() {
        ...
        String seq = Clipboard.buildOsc52Sequence(text, false, false);
    ...
    void osc52TmuxWrapsDcs() {
        String text = "test";
        String seq = Clipboard.buildOsc52Sequence(text, true, false);
    ...
    void osc52ScreenWrapsDcs() {
        String text = "test";
        String seq = Clipboard.buildOsc52Sequence(text, false, true);
    ...
    void isWithinOsc52LimitAccepts99KB() {
        ...
        assertThat(Clipboard.isWithinOsc52Limit(small)).isTrue();
    }

    @Test
    void isWithinOsc52LimitRejects101KB() {
        String large = "x".repeat(101_000);
        assertThat(Clipboard.isWithinOsc52Limit(large)).isFalse();
    }
}
